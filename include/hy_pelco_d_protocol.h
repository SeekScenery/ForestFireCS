...
#define EDIT_IP             0X01   //修改云台IP地址
#define EDIT_MAC            0X02   //修改云台MAC地址
#define EDIT_NETMASK        0X03   //修改云台NETMASK
#define EDIT_GATEWAY        0X04   //修改云台GATEWAY
/*
...
unsigned int edit_cfg_file_head_crc(PTZ_DATA_PACK_A *pack)
//配置文件修改
void edit_cfg_file(char *data, u_int8_t content)
//云台转动控制
